            ...
            <div class="site-branding absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                <a class="flex items-center justify-center" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                    <div class="logo-light w-full">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo_light.svg" alt="<?php bloginfo('name'); ?>">
                    </div>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo_brown.svg" alt="<?php bloginfo('name'); ?>" class="logo-dark hidden">
                </a>
            </div>
